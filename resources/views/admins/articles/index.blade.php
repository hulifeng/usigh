                            ...
                            <table class="table table-hover">
                                ...
                                @foreach($articles as $article)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="row">
                                                <form action="{{ route('admins.articles.edit', array('article' => $article->id)) }}" method="get">
                                                    {{ csrf_field() }}
                                                ...
                                                <form action="{{ route('admins.articles.delete', array('article' => $article->id)) }}" method="post">
                                                    {{ method_field("DELETE") }}
                                                    {{ csrf_field() }}
                                                    <button class="m-l-10 btn btn-mini btn-warning btn-danger waves-effect waves-light" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="移至回收站">
                                                        <i class="ti-trash"></i>
                                                    </button>
                                                </form>
